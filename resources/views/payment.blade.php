                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_surname" id="name_surname" value="{{  auth()->user()->name_surname}}" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="address">Adres</label>
                                <input type="text" class="form-control" name="address" id="address" value="{{ $userdetail->address }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="phone" id="phone" value="{{ $userdetail->phone }}" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="mobilphone">cep telefonu</label>
                                <input type="text" class="form-control telefon" name="mobile_phone" id="mobile_phone" value="{{ $userdetail->mobile_phone }}" required>
                            </div>
                        </div>
                    </div>
