                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control kredikarti" id="cardnumber" name="cardnumber"
                                   style="font-size:20px;" value="2222222222222222" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_surname" id="name_surname"
                                           value="{{  auth()->user()->name_surname}}" required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="mobile_phone"
                                           id="mobile_phone" value="{{ $userdetail->mobile_phone }}" required>
                                </div>
                            </div>
                        </div>
