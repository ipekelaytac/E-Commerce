...
@section('content')
    ...
    <main>
        <div class="top_banner">
            ...
            <img src="customer/img/bg_cat_shoes.jpg" class="img-fluid" alt="">
        </div>
        <!-- /top_banner -->
                    ...
                    <li>
                        <div class="sort_select">
                            <select name="sort" id="sort">
                                <option value="popularity" selected="selected">Sırala</option>
                                <option value="rating">Azdan Çok</option>
                                <option value="date">Çoktan AZ</option>
                                <option value="price">Eskiden Yeni</option>
                                <option value="price-desc">Yeniden Eski</option>
                            </select>
                        </div>
                    </li>
                    <li>
