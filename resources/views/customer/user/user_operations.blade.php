    ...
    <main class="bg_gray">
        ...
        <div class="container margin_30">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="box_account">
                        ...
                        <div class="form_container">
                            ...
                            <div class="clearfix add_bottom_15">
                                ...
                                <div class="float-end"><a id="forgot" href="javascript:void(0);">Şifre Yenile?</a></div>
                            </div>
                            <div class="text-center"><input type="submit" value="Giriş Yap" class="btn_1 full-width">
                            </div>
                            <div id="forgot_pw">
                                <div class="form-group">
                                ...
                                <div class="text-center"><input type="submit" value="Şifre Yenile" class="btn_1"></div>
                            </div>
                        </div>
                        <!-- /form_container -->
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-8">
                    <div class="box_account">
                        <h3 class="new_client">Yeni Müşteri</h3> <small class="float-right pt-2">* Yeni Müşteri Zorunlu
                            Alanlar</small>
                        <div class="form_container">
                            <div class="form-group">
