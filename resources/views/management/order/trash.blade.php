...
@section('title', 'Siparişler Çöp Kutusu')
@section('header')
                        ...
                        <table id="basicDataTable" class="table card-table tx-center">
                            ...
                            @foreach ($list as $entry)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $entry->order_price }} ₺</td>
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li class="dropdown-item"><a class="dropdown-link tx-13 tx-gray-500" href="{{ route('management.order.remove' , $entry->id) }}"><i class="icon-close mr-2"></i>Kaldır</a></li>
                                                <li class="dropdown-item"><a class="dropdown-link tx-13 tx-gray-500" href="{{ route('management.order.restore' , $entry->id) }}"><i class="icon-note mr-2"></i>Geri Yükle</a></li>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
