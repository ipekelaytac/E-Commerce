...
@section('title', 'Ürünler Çöp Kutusu')
@section('header')
...
@section('content')
    ...
    <div class="pageheader">
        <div class="row pd-t-5 pd-b-25 justify-content-between pd-x-20">
            <div class="pull-left"><h1 class="pd-0 mg-0 tx-20 text-overflow">Ürünler Çöp Kutusu</h1></div>
        </div>
    </div>
                        ...
                        <table id="basicDataTable" class="table card-table tx-center">
                            ...
                            @foreach($list as $entry)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $entry->deleted_at }}</td>
                                    <td class="tx-center">
                                        <div class="dropdown">
                                            <a href="" data-toggle="dropdown" aria-haspopup="true"
                                               aria-expanded="false"><i class="icon-options"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li class="dropdown-item"><a class="dropdown-link tx-13 tx-gray-500" href="{{ route('management.product.remove' , $entry->id) }}"><i class="icon-close mr-2"></i>Kaldır</a></li>
                                                <li class="dropdown-item"><a class="dropdown-link tx-13 tx-gray-500" href="{{ route('management.product.restore' , $entry->id) }}"><i class="icon-note mr-2"></i>Geri Yükle</a></li>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
