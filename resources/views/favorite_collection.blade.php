                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <li class="dropdown-item">Bu Koleksiyonu silmek istediğinize emin misiniz?
                                            </li>
                                        </div>

                                        <div class="modal-footer">
                                            <a class="dropdown-link tx-13 tx-gray-500"
                                               href="{{ route('collection_delete' , $collection->id) }}">
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Sil
                                                </button>
                                            </a>
