...
return [
    ...
    */
    ...
    | storing and restoring a mainCart.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Destroy the mainCart on user logout
    |--------------------------------------------------------------------------
    |
    | When this option is set to 'true' the mainCart will automatically
    | destroy all mainCart instances when the user logs out.
    |
    */
